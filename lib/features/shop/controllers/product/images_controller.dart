...
class ImagesController extends GetxController {
  static ImagesController instance = Get.find();

  // Variables 
  Rx<String> selectedProductImage = ''.obs;

  // -- Get all Images from product and varation 
  ...
  List<String> getAllProductImages(ProductModel product) {
    ...
    // Assasgin Thumbnail as selected image
    ...
    // Get all iamges from the product variation if not null
